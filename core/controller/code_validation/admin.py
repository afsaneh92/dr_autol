...
class CodeValidationAdminController(BaseController):
    ...
    def execute(self):
        ...
        result = self._update_admin(result[1])
    ...
    def _is_registered_before(self):
        find_results = Administrator.find(code=self.code.code, phone_number=self.code.phone_number)
