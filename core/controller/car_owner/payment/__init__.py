...
class BasePaymentOperationController(BaseController):
    dct = {
        Keys.FULL_PAYMENT_REQUEST: ReflectionControllers.FULL_PAYMENT_CONTROLLER,
        Keys.INSTALLMENT_PAYMENT_REQUEST: ReflectionControllers.INSTALLMENT_PAYMENT_CONTROLLER,
    }
    ...
    def execute(self):
        ...
        klass = ret[1](self.job, self.payment, self.converter)
